...
INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (2, 'Michael Smith', 'San Francisco, CA', 'No experience', 'Requires Sponsorship', 90, 8);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (3, 'Sophia Davis', 'New York, NY', 'Previous internship', 'Green Card Holder', 78, 12);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (4, 'Liam Brown', 'Austin, TX', 'No experience', 'US Citizen', 65, 5);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (5, 'Olivia Wilson', 'Chicago, IL', 'Previous co-op', 'Requires Sponsorship', 88, 14);
...
INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (9, 'Isabella Thomas', 'Los Angeles, CA', 'Previous internship', 'US Citizen', 79, 6);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (10, 'William Jackson', 'Dallas, TX', 'No experience', 'Green Card Holder', 87, 13);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (11, 'Emma Moore', 'Philadelphia, PA', 'Previous internship', 'US Citizen', 69, 10);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (12, 'Lucas Martin', 'Boston, MA', 'Previous co-op', 'Green Card Holder', 92, 8);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (13, 'Charlotte Lee', 'Austin, TX', 'No experience', 'Requires Sponsorship', 76, 9);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (14, 'Benjamin Perez', 'San Francisco, CA', 'Previous internship', 'US Citizen', 81, 11);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (15, 'Amelia Thompson', 'New York, NY', 'Previous co-op', 'Green Card Holder', 88, 13);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (16, 'Elijah White', 'Denver, CO', 'No experience', 'Requires Sponsorship', 74, 6);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (17, 'Mia Harris', 'Miami, FL', 'Previous internship', 'US Citizen', 79, 10);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (18, 'Oliver Sanchez', 'Los Angeles, CA', 'Previous co-op', 'Green Card Holder', 82, 12);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (19, 'Harper Clark', 'Philadelphia, PA', 'No experience', 'Requires Sponsorship', 71, 8);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (20, 'Henry Ramirez', 'Chicago, IL', 'Previous internship', 'US Citizen', 77, 9);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (21, 'Evelyn Lewis', 'Dallas, TX', 'Previous co-op', 'US Citizen', 81, 7);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (22, 'Alexander Robinson', 'Austin, TX', 'No experience', 'Green Card Holder', 64, 6);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (23, 'Abigail Walker', 'San Francisco, CA', 'Previous internship', 'Requires Sponsorship', 83, 11);

INSERT INTO Student (StudentID, Name, Location, ExperienceLevel, WorthAuthorization, EngagementScore, Communication) 
VALUES (24, 'Sebastian Young', 'New York, NY', 'No experience', 'US Citizen', 76, 8);
